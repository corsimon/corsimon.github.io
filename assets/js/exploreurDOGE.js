...
xmlhttp.open("GET", "https://api.blockcypher.com/v1/doge/main", true);
xmlhttp.send();
...
$('#form1').on('submit', function(event) {
    ...
    $.ajax("https://api.blockcypher.com/v1/doge/main/addrs/" + input, {
...
$('#form2').on('submit', function(event) {
    ...
    event.preventDefault();
    var input = $('#hashT').val();
    $.ajax("https://api.blockcypher.com/v1/doge/main/txs/" + input, {
        success: function(result) {
            $('#result').html(
...
$('#form3').on('submit', function(event) {
    ...
    event.preventDefault();
    var input = $('#hashB').val();
    $.ajax("https://api.blockcypher.com/v1/doge/main/blocks/" + input, {
        //$.ajax(q.url, {
        success: function(result) {
            $('#result').html(
...
https://dogechain.info/api/v1/address/qrcode
